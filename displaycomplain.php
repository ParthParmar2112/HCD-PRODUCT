...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="displaycomplain.php">COMPLAINTS</a></li>
...
$result1 = mysqli_query($conn,"SELECT * FROM complain");
...
$sql = "SELECT * FROM complain where Status=1 LIMIT  $initial_page,$limit";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    echo "<tr><td>".$row['name']."</td><td>".$row['email']."</td><td>".$row['complain']."</td>
...
for($page_number = 1; $page_number<= $total_pages; $page_number++) {
  echo '<a href = "displaycomplain.php?page=' . $page_number . '">' . $page_number . ' </a>';  
}
