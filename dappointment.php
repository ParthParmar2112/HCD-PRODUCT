...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="dappointment.php">APPOINTMENTS</a></li>
...
$sql = "SELECT * FROM appointment where Status=1 LIMIT  $initial_page,$limit";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    echo "<tr><td>".$row['NAME']."</td><td>".$row['EMAIL']."</td><td>".$row['SERVICES']."</td><td>".$row['DATE']."</td><td>".$row['TIME']."</td><td>".$row['PHONE']."</td>
...
for($page_number = 1; $page_number<= $total_pages; $page_number++) {
  echo '<a href = "dappointment.php?page=' . $page_number . '">' . $page_number . ' </a>';  
}
